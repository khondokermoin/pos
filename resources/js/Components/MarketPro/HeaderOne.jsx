...
const HeaderOne = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            console.warn("Select2 initialization skipped:", error);
            return undefined;
        }
    }, []);
