    ...
    <div class="container-fluid">
        <div class="row mb-3 align-items-center">
            ...
            <div class="col-sm-6 text-sm-end">
                <a href="{{ route('company.sales-returns.create') }}" class="btn btn-primary">
            ...
            <div class="card-body">
                @if ($returns->isEmpty())
                    <div class="text-center py-5 text-muted">
                        ...
                        <h5 class="fw-semibold">No Sales Returns Yet</h5>
                        <p class="small mb-3">Record a return when a customer brings back sold items.</p>
                        <a href="{{ route('company.sales-returns.create') }}" class="btn btn-sm btn-primary">
                            ...
                            <tbody>
                                @foreach ($returns as $return)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <form action="{{ route('company.sales-returns.destroy', $return->id) }}"
