...
@section('content')
    ...
    <div class="row mb-3 align-items-center">
        <div class="col-sm-6">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 mt-1">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('company.sales-returns.index') }}">Sales Returns</a></li>
        ...
        <div class="col-sm-6 text-sm-end d-flex gap-2 justify-content-end">
            ...
            <a href="{{ route('company.sales-returns.index') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="row">
                            ...
                            <tbody>
                                @foreach ($return->items as $i => $item)
                                    <tr>
                                        ...
                                        <td>{{ optional(optional($item->saleItem)->variant->product)->name ?? '—' }}</td>
        ...
        <div class="col-lg-4">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr>
                            <td class="text-muted">Original Sale</td>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('company.sales-returns.destroy', $return->id) }}" method="POST"
