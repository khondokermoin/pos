...
@section('content')
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-md-6">
                <h4 class="page-title">Edit Branch: {{ $branch->name }}</h4>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="ti ti-building-store me-2"></i>Branch Information</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email"
                                        ...
                                        value="{{ old('email', $branch->email) }}" placeholder="e.g., branch@example.com">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                ...
                {{-- Branch Meta Info Card --}}
                <div class="card mt-3">
                    <div class="card-body">
                        <h6 class="text-muted small text-uppercase fw-semibold mb-3">Branch Information</h6>
